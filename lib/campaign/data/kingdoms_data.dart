...
const List<KingdomModel> kKingdoms = [
  KingdomModel(
    ...
    difficulty: 1,
    bannerAsset: AppAssets.northernForest,
    symbolAsset: AppAssets.vikingHelmet,
  ...
  KingdomModel(
    ...
    difficulty: 1,
    bannerAsset: AppAssets.grasslandArmy,
    symbolAsset: AppAssets.deer,
  ...
  KingdomModel(
    ...
    difficulty: 2,
    bannerAsset: AppAssets.ottoman,
    symbolAsset: AppAssets.ottomanSigil,
  ...
  KingdomModel(
    ...
    difficulty: 3,
    bannerAsset: AppAssets.roman,
    symbolAsset: AppAssets.romanHelmet,
  ...
  KingdomModel(
    ...
    difficulty: 3,
    bannerAsset: AppAssets.costalFort,
    symbolAsset: AppAssets.eagle,
  ...
  KingdomModel(
    ...
    difficulty: 4,
    bannerAsset: AppAssets.tibet,
    symbolAsset: AppAssets.dragon,
  ...
  KingdomModel(
    ...
    difficulty: 5,
    bannerAsset: AppAssets.sangaNagaram,
    symbolAsset: AppAssets.risingSun,
